...
namespace _Main.Scripts.Weapons
{
    ...
    {
        private readonly WeaponSwitchData _data;
        ...
        public WeaponSwitchController(WeaponSwitchData data, WeaponController[] slots, Transform defaultLocalPosition,
        ...
        public Vector3 CalculateSwitchMovement()
        {
            ...
            if (_data.switchDelay == 0f)
            {
                switchingTimeFactor = 1f;
            }
            else
            {
                switchingTimeFactor = Mathf.Clamp01((Time.time - _timeStartedWeaponSwitch) / _data.switchDelay);
            }
    ...
    {
        [Range(0,2)]public float switchDelay = 1;
    }
}